    ...
    switch (material.tipo) {
      ...
      case TipoMaterial.mapaMental:
        context.push(AppRoutes.documentoMapaMental(widget.docId),
            extra: material);
      case TipoMaterial.test:
        context.push(AppRoutes.documentoTest(widget.docId),
            extra: DocumentoTest.fromMaterial(material));
    }
  }
...
class _AccionesGeneracion extends StatelessWidget {
  ...
  IconData _iconoTipo(TipoMaterial tipo) => switch (tipo) {
        ...
        TipoMaterial.test => Icons.quiz_outlined,
      };
}
...
class _MaterialTile extends StatelessWidget {
  ...
  Color _colorTipo(TipoMaterial tipo, Brightness b) => switch (tipo) {
        ...
        TipoMaterial.test => AppColors.primaryFor(b),
      };
}
